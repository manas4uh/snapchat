...
from spy_details import spy # Here i imported specific spy details from a file name spy_details.
...
friends=[{'name':'Manas','age':20,'rating':4.5,'online':True,'chats':[]},{'name':'faisal','age':22,'rating':4.7,'online':True,'chats':[]}]
